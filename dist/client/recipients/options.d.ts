...
declare type RegisterInformationInput = RegisterInformationInputIndividual | RegisterInformationInputCorporation;
/**
...
export declare type RecipientUpdateOptions = {
    recipient_id: string;
